...
class Admin:
    ...
    def __init__(self):
        self.username = self.login_setup_u()
        self.password = self.login_setup_p()

    def login_setup_u(self):
        return input('set new username> ')
        
    def login_setup_p(self):
        return input('set new password: ')
...
def builder(id, nym, arc):
    try:
        from ipfs import initialize_ipfsapi, add_file
        initialize_ipfsapi()
